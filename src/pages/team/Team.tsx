  ...
  return (
    <div className='team'>
      ...
      <div className='team_contents'>
         <Teamboxleads name='varsha renjith' position='GDSC MBCET lead'  border='none' backgroundColor='rgba(109, 185, 246, 1)' padding='0px' height='225px' img={VarshaRenjith} class='lead'/>
        <Teamboxleads backgroundColor='rgba(109, 185, 246, 1)' height='225px' width='602px'/>
        ...
        <Teamboxleads name='yoosuf mohammed' position='tech lead'  border='none' backgroundColor='rgba(229, 119, 119, 1)' padding='0px' width='470px' height='225px' img={Yoosuf} class='lead'/>
        ...
        <Teamboxleads padding='30px' name='tech team' backgroundColor='rgba(229, 119, 119, 1)' height='225px' width='432px'/>
        ...
        <Teamleads2 name='r sreelakshmi' position='graphic design lead'  border='none' backgroundColor='rgba(136, 203, 139, 1)' padding='0px' height='225px' img={Sreelakshmi} class='lead' width='490px'/>
        <Teamboxleads name='k s mithun' position='motion design lead'  border='none' backgroundColor='rgba(136, 203, 139, 1)' padding='0px' height='225px' img={Mithun} class='lead'/>
        <Teambox name='vinu kurup' position='graphic designer' border='rgba(136, 203, 139, 1) 2px solid' padding='0px' height='225px' img={Vinu} />
        <Teamboxleads padding='30px' name='design team' backgroundColor='rgba(136, 203, 139, 1)' height='225px' width='280px'/>
        <Teamleads2 name='ben george' position='operations lead'  border='none' backgroundColor='rgba(220, 192, 101, 1)' padding='0px' height='225px' img={Ben} class='lead' width='480px' />
        ...
        <Teamboxleads padding='30px' name='organizing team' backgroundColor='rgba(220, 192, 101, 1)' height='225px' width='332px'/>
        <Teambox name='sam peter' position='community organizer' border='rgba(220, 192, 101, 1) 2px solid' padding='0px' height='225px' img={Sam} />
        <Teamleads2 name='litto k lal' position='management lead'  border='none' backgroundColor='rgba(220, 192, 101, 1)' padding='0px' height='225px' img={Litto} class='lead' width='450px'/>
        <Teambox name='joel lpe' position='content curator' border='rgba(115, 187, 246, 1) 2px solid' padding='0px' height='225px' img={Joel} />
        <Teamleads2 name='noel varughese' position='social lead'  border='none' backgroundColor='rgba(115, 187, 246, 1) ' padding='0px' height='225px'  img={Noel} class='lead'/>
        ...
        <Teamboxleads padding='30px' name='social media team' backgroundColor='rgba(115, 187, 246, 1)' height='225px' width='452px'/>
        <Teambox name='c rachana' position='content curator' border='rgba(115, 187, 246, 1) 2px solid' padding='0px' height='225px' img={Rachana} />
        <Teamboxleads padding='30px' backgroundColor='rgba(115, 187, 246, 1)' height='225px' width='299px'/>
      </div>
    </div>
  )
}
