...
function Home() {
  ...
  useEffect(() => {
    ...
    const landing_heading_text = document.getElementById(
      "home_landing_head_top",
    );
    const landing_heading_text_bottom = document.getElementById(
      "home_landing_head_bottom",
    );
    const earth_text = document.getElementById("home_earth_content");

    const landingTextRect = landing_text?.getBoundingClientRect();
    const landingHeadingTextRect =
      landing_heading_text?.getBoundingClientRect();
    const landingHeadingTextBottomRect =
      landing_heading_text_bottom?.getBoundingClientRect();
      ...
      <div className="home_about">
        ...
        <div className="home_about_inner">
          <div className="home_about_content">
            <p>
              A community that <b>grows and builds</b> together! From the tech
              domain to the social domain, we do{" "}
              <b>the cool things that matter</b>.<br></br>
              <br></br>
              This ain't your regular club, so are you ready to{" "}
              <b>take on the challenge to level up</b>?
            </p>
          </div>
